...
## Ohjelman tarkoitus
---
Skripti on automatisoitu työkalu videotuotannon hallintaan. Sen avulla sisällöntuottaja voi luoda yhdellä komennolla standardisoidun kansiorakenteen uudelle videoprojektille. Ohjelma vähentää manuaalista työtä ja varmistaa, että kaikki tarvittavat resurssit pysyvät järjestyksessä.
...
Syötä avautuvaan ikkunaan projektin nimi ja valitse julkaisualusta.
...
**Oikeudet ja järjestelmävirheet:** Jos kansioiden luonti epäonnistuu esimerkiksi kirjoitusoikeuksien puuttumisen tai muun odottamattoman levyvirheen vuoksi, catch-lohko nappaa virheen ja näyttää siitä teknisen selvennyksen käyttäjälle graafisessa ikkunassa koodin kaatumisen sijaan.

## Siirrettävyys ja Ympäristö
---
**Käyttöjärjestelmä:** Windows 11 - PowerShell 5.1

**OneDrive-tuki:** Skripti käyttää dynaamista metodia, joten se löytää automaattisesti nykyisen käyttäjän työpöydän riippumatta siitä, onko koneella käytössä paikallinen profiili vai OneDrive-varmuuskopiointi. Skripti ei vaadi asennusta.
